...
struct AllocatorVTableV2
{
    void* (IAllocator::* alloc)(u64 mCount, u64 mSize);
    void* (IAllocator::* zalloc)(u64 mCount, u64 mSize);
    void* (IAllocator::* realloc)(void* ptr, u64 mCount, u64 mSize);
    void (IAllocator::* free)(void* ptr);
    void (IAllocator::* freeAll)();
};

struct IAllocator
{
    const AllocatorVTableV2* pVTable {};

    [[nodiscard]] ADT_NO_UB constexpr void* alloc(u64 mCount, u64 mSize) { return (this->*pVTable->alloc)(mCount, mSize); }
    [[nodiscard]] ADT_NO_UB constexpr void* zalloc(u64 mCount, u64 mSize) { return (this->*pVTable->zalloc)(mCount, mSize); }
    [[nodiscard]] ADT_NO_UB constexpr void* realloc(void* p, u64 mCount, u64 mSize) { return (this->*pVTable->realloc)(p, mCount, mSize); }
    ADT_NO_UB constexpr void free(void* ptr) { (this->*pVTable->free)(ptr); }
    ADT_NO_UB constexpr void freeAll() { (this->*pVTable->freeAll)(); }
};
