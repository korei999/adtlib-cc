...
inline const AllocatorVTable inl_chunkAllocatorVTable {
    .alloc = decltype(AllocatorVTable::alloc)(+[](ChunkAllocator* s, u64 mCount, u64 mSize) { return s->alloc(mCount, mSize); }),
    .zalloc = decltype(AllocatorVTable::zalloc)(+[](ChunkAllocator* s, u64 mCount, u64 mSize) { return s->zalloc(mCount, mSize); }),
    .realloc = decltype(AllocatorVTable::realloc)(+[](ChunkAllocator* s, void* ptr, u64 mCount, u64 mSize) { return s->realloc(ptr, mCount, mSize); }),
    .free = decltype(AllocatorVTable::free)(+[](ChunkAllocator* s, void* ptr) { s->free(ptr); }),
    .freeAll = decltype(AllocatorVTable::freeAll)(+[](ChunkAllocator* s) { s->freeAll(); } ),
};
