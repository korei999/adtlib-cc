...
export [[nodiscard]] constexpr ssize
...
export [[nodiscard]] inline bool operator==(const StringView& l, const StringView& r);
export [[nodiscard]] inline bool operator==(const StringView& l, const char* r);
export [[nodiscard]] inline bool operator!=(const StringView& l, const StringView& r);
export [[nodiscard]] inline i64 operator-(const StringView& l, const StringView& r);

export inline String StringCat(IAllocator* p, const StringView& l, const StringView& r);
...
export struct String : public StringView
{
    String() = default;
